...
em++ \
  ...
  -sEXPORTED_FUNCTIONS='["_malloc","_free","_wasm_pdf_last_error","_wasm_pdfium_init","_wasm_pdfium_destroy","_wasm_pdf_open_from_bytes","_wasm_pdf_close","_wasm_pdf_page_count","_wasm_pdf_get_page_size","_wasm_pdf_get_page_rotation","_wasm_pdf_set_page_rotation","_wasm_pdf_get_page_box","_wasm_pdf_set_page_box","_wasm_pdf_set_page_size","_wasm_pdf_get_permissions","_wasm_pdf_get_metadata","_wasm_pdf_set_metadata","_wasm_pdf_get_outline","_wasm_pdf_attachment_count","_wasm_pdf_add_attachment","_wasm_pdf_set_attachment_file","_wasm_pdf_delete_attachment","_wasm_pdf_get_attachment_info","_wasm_pdf_get_attachment_file","_wasm_pdf_get_form_fields","_wasm_pdf_set_form_field_value","_wasm_pdf_set_form_field_checked","_wasm_pdf_set_form_field_selected_index","_wasm_pdf_get_page_text","_wasm_pdf_get_page_text_runs","_wasm_pdf_search_page_text","_wasm_pdf_redact_page_text","_wasm_pdf_annotation_count","_wasm_pdf_get_annotation_info","_wasm_pdf_delete_annotation","_wasm_pdf_add_highlight_annotation","_wasm_pdf_add_link_annotation","_wasm_pdf_add_text_note_annotation","_wasm_pdf_add_rectangle_annotation","_wasm_pdf_add_freetext_annotation","_wasm_pdf_set_annotation_rect","_wasm_pdf_set_annotation_color","_wasm_pdf_set_annotation_border","_wasm_pdf_set_annotation_text","_wasm_pdf_set_annotation_uri","_wasm_pdf_page_object_count","_wasm_pdf_get_page_object_info","_wasm_pdf_delete_page_object","_wasm_pdf_replace_text_page_object","_wasm_pdf_transform_page_object","_wasm_pdf_duplicate_page_object","_wasm_pdf_insert_blank_page","_wasm_pdf_delete_page","_wasm_pdf_copy_page","_wasm_pdf_import_pages","_wasm_pdf_add_text_page","_wasm_pdf_add_text_box_page","_wasm_pdf_add_rgba_image_page","_wasm_pdf_add_jpeg_image_page","_wasm_pdf_add_png_image_page","_wasm_pdf_render_page_rgba","_wasm_pdf_render_page_area_rgba","_wasm_pdf_save_copy","_wasm_pdf_free_buffer"]' \
