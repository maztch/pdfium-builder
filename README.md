...
- Query page count, page size, rotation, boxes, permissions, metadata, outline/bookmarks, embedded attachments, AcroForm fields, annotations, page objects, text, and text search rectangles.
- Mutate page rotation, page boxes, page size, metadata, embedded attachments, AcroForm field values, pages, page objects, annotations, text, and RGBA/JPEG/PNG images.
